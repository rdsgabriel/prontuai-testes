  ...
  return (
    <div className="relative inline-flex bg-white rounded-md border border-black/[0.08] shadow-sm -space-x-px">
      <TooltipProvider delayDuration={0}>
        <ActionButton icon={<RiBookLine size={16} />} label="Salvar" />
        <ActionButton icon={<RiLoopRightFill size={16} />} label="Atualizar" />
        <ActionButton icon={<RiCheckLine size={16} />} label="Aprovar" />
      </TooltipProvider>
    </div>
  );
}
